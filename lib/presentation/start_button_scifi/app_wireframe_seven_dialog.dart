...
class AppWireframeSevenDialog extends StatelessWidget {
  const AppWireframeSevenDialog({Key? key}) : super(key: key);
  ...
  onTapThirtyFour(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.appWireframeFortyoneScreen);
  }
}
