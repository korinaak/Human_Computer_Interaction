...
class WinnerTheGreatOneScreen extends StatelessWidget {
  final String selectedBook;

  const WinnerTheGreatOneScreen({Key? key, required this.selectedBook})
      : super(key: key);
...
// Display the selected book image
                      CustomImageView(
                          imagePath:
                              selectedBook, // Use the selected book image path
                          height: 300.v,
                          width: 200.h,
